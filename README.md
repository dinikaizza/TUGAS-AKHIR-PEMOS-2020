...
### Hidrodinamika 1D dalam pemodelan script phyton
Import Jupyter Library

    import matplotlib.pyplot as plt
    import numpy as np

Proses Awal, memasukkan nilai awal
...
Pembuatan Grafik
    ...
    for i in range(1, 16):
        ...
        ax0.set(xlabel='Waktu', ylabel='Kecepatan Arus',
               title='''Kelompok 14_Pemodelan MD3
...
### Hasil
![MD 3 perubahan arus thd kec](https://user-images.githubusercontent.com/105905933/170220500-2f577dae-297f-431f-b8cd-3e3fb0ba4181.png)
![perubahan elevasi](https://user-images.githubusercontent.com/105905933/170220535-a8337073-18e9-4939-a5db-584720493c31.png)
![perubahan kec arus sepanjang grid](https://user-images.githubusercontent.com/105905933/170220565-fc9499b1-7b97-4f56-84ad-02ddcf83c3e1.png)
![perubahan permukaan sepanjang grid](https://user-images.githubusercontent.com/105905933/170220595-e6548579-12c4-43a5-a48c-d1524b38ab13.png)

### Pembahasan
Pada grafik menunjukan perubahan grafik secara tidak beratur/tidak beraturan. Hasil ini dikarenakan amplitudo sudah melewati syarat batas sehingga perairan mengalami floating poitn overflow. Secara umum, floating point overflow terjadi setiap kali nilai yang diberikan ke variabel lebih besar dari nilai maksimum yang mungkin untuk variabel itu. Floating point overflows di MODFLOW dapat menjadi gejala dari masalah pada model. Sedangkan untuk hasil yang teratur atau halus dapat terjadi karena nilai-nilai yang digunakan masih nilai kecil sehingga belum melebihi nilai maksimum atau nilai batas. Nilai batas yang digunakan utnuk periode adalah 300. Namun menjadi teratur lagi di akhir grid setelah terjadi perhitungan. 
